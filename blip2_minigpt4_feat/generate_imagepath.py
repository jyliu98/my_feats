...
ROOT_PATH = "/data1/ljy/VisualSearch1"
...
def process(options, collection):
    ...
    if collection.startswith('v3c'):
        imageFolders = [os.path.join(rootpath, collection, 'FrameData')]
    filenames = []
    imageset = set()
    
    print('loading')
    for imageFolder in imageFolders:
        for r,d,f in os.walk(imageFolder,followlinks=True):
    ...
    print('writing into imagepath file')
